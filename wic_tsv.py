...
class LSTMClassifier(nn.Module):
    def __init__(self, vocab_size, embedding_dim, output_size, hidden_size=256):
        super().__init__()
...
# Train model
model = LSTMClassifier(len(word_index)+1, 256, len(set(labels)))
...
for i in range(len(predicted_labels)):
    if predicted_labels[i] == "positive" and test_labels[i] == "positive":
        true_positives += 1
    elif predicted_labels[i] == "positive" and test_labels[i] == "negative":
        false_positives += 1
    elif predicted_labels[i] == "negative" and test_labels[i] == "positive":
        false_negatives += 1
